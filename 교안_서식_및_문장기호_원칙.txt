...
[규칙 8. 준동사 문장기호 (top_label)]
  - to부정사, 동명사, 분사구문 등 준동사구 내의 서술어 성분에는 top_label: "Vt" (또는 "Vi"), 목적어 성분에는 top_label: "O"를 단어 위에 작게 표기.
  - (예: To minimize building costs ➔ minimize 위에 Vt, building costs 위에 O)
