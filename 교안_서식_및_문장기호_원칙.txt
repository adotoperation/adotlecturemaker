...
[규칙 1. 표준 문장 성분 기호 및 색상 (단어 하단 sub_tag 표기)]
  - 주어 (S): 파란색 (blue), 주절인 경우 밑줄(underline) 적용 및 문장기호 1.2배 확대
  - 자동사 (Vi): 빨간색 (rose), 주절인 경우 밑줄(underline) 적용 및 문장기호 1.2배 확대
  - 타동사 (Vt): 빨간색 (rose), 주절인 경우 밑줄(underline) 적용 및 문장기호 1.2배 확대
  - [★핵심 식별 규칙★] 주절의 주어(S) 및 주절의 동사(V/Vi/Vt) 문장 기호는 종속절/준동사 및 기타 문장기호(O, SC, OC 등)보다 1.2배 크게(Web: 11.5~12px, PDF: 8.5pt) 표기하여 학생들이 문장의 뼈대를 직관적으로 쉽게 구별하도록 함.
